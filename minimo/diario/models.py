...
class Attivita(models.Model):
    cliente = models.ForeignKey(Cliente, blank=True, null=True, default=None)
...
class Riga(models.Model):
    ...
    tipo = models.CharField('Tipo riga', max_length=5, choices=TIPO_RIGA, blank=True, null=True, default=None)
