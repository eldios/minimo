...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Attivita.cliente'
        db.alter_column(u'diario_attivita', 'cliente_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cliente.Cliente'], null=True))

    def backwards(self, orm):

        # Changing field 'Attivita.cliente'
        db.alter_column(u'diario_attivita', 'cliente_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['cliente.Cliente']))
