...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Riga.tipo'
        db.alter_column(u'diario_riga', 'tipo', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))

    def backwards(self, orm):

        # Changing field 'Riga.tipo'
        db.alter_column(u'diario_riga', 'tipo', self.gf('django.db.models.fields.CharField')(default='', max_length=5))
    ...
    models = {
        ...
        u'diario.attivita': {
            ...
            'cliente': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['cliente.Cliente']", 'null': 'True', 'blank': 'True'}),
        ...
        u'diario.riga': {
            ...
            'cliente': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cliente.Cliente']", 'null': 'True'}),
            ...
            'tipo': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '5', 'null': 'True', 'blank': 'True'})
        }
    }
