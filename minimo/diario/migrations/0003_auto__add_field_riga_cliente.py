...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Riga.cliente'
        db.add_column(u'diario_riga', 'cliente',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cliente.Cliente'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Riga.cliente'
        db.delete_column(u'diario_riga', 'cliente_id')
